...
<head>
    ...
    <style>
        ...
        .logo-kismet {
            ...
            text-shadow: 2px 2px 10px rgba(255, 75, 43, 0.2);
        }
        ...
        .success { background-color: rgba(27, 94, 32, 0.2); color: #c8e6c9; border-color: #2e7d32; }
...
<body>
    ...
    <div class="form-container">
        ...
        <%      } else if("error".equals(status)) { %>
                    <div class="alert error">Une erreur technique est survenue. Réessayez.</div>
        ...
        <%      } else if("email_exists".equals(status)) { %>
                    <div class="alert error">Cet email est déjà lié à un compte Kismet.</div>
        <%      }
            }
        %>
